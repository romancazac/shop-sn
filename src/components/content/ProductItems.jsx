...
import img from "../../img/pro1.jpg"
function ProductItems({link,title,price,id, onPlus}) {
        ...
        <div className="products__column">
                    <div className="products__items">
                        ...
                        <div className="products__footer">
                            ...
                            <button className="products__add" onClick={ onClickPlus}>+</button>
                        </div>
                    </div>
        </div>
