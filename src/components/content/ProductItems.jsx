...
function ProductItems({link,title,price,id, onPlus,onWish, favorited = false}) {
    ...
    return(
        <div className="products__column">
                    <div className="products__items">
                        <span className="products__wish" onClick={onClickWish}>
                        ...
                        <img src={link} alt="" className="products__img" />
                        ...
                        <div className="products__footer">
                            ...
                            <div className="products__price">
                                <p className="products__name">Цена</p>
                                <span className="products__number">{price}руб.</span>
                            </div>
                            <button className="products__add" onClick={ onClickPlus}><img  src={add ? plus : ch }/> </button>
                        </div>
                    </div>
        </div>
